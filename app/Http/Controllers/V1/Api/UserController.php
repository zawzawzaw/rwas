...
class UserController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $update = [
            ...
            'paraDRSWorkgroup' => $this->DRSWORKGROUP,
            'paraCardTypeCode' => '99',
            'paraCid' => (String) $input['paraCid'],
            'paraEmail' => (String) $input['paraEmail'],
            'paraHOME' => (String) $input['paraHOME'],
            'paraBUSINESS' => (String) $input['paraBusiness'],
            'paraMOBILE' => (String) $input['paraMOBILE'],
            'paraSMS' => (String) $input['paraSMS'],
            'paraAdd1' => (String) $input['paraAdd1'],
            'paraAdd2' => (String) $input['paraAdd2'],
            'paraAdd3' => (String) $input['paraAdd3'],
            'paraCity' => (String) $input['paraCity'],
            'paraState' => (String) $input['paraState'],
            'paraCountry' => (String) $input['paraCountry'],
            'paraPostcode' => (String) $input['paraPostcode'],
            'paraPreLanguage' => 'EN',
            'PF1Field' => '',
            'PF1Value' => '',
            'PF2Field' => '',
