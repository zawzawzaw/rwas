...
goog.provide('rwas.model.Constants');

//    ____   ___  ____ _____   ____    _  _____  _
//   |  _ \ / _ \|  _ \_   _| |  _ \  / \|_   _|/ \
//   | |_) | | | | |_) || |   | | | |/ _ \ | | / _ \
//   |  __/| |_| |  _ < | |   | |_| / ___ \| |/ ___ \
 ...
 * @type {Array}
 */
rwas.model.Constants.PORT_DATA = [
  {
 ...
 * @type {Array}
 */
rwas.model.Constants.CABIN_DATA = [
  {
    "cabin_code": "BDA",
 ...
 * @param  {string} port_str
 * @return {Object}
 */
rwas.model.Constants.get_port_data = function(port_str){

  var item = null;

  for (var i = 0, l=rwas.model.Constants.PORT_DATA.length; i < l; i++) {

    item = rwas.model.Constants.PORT_DATA[i];

    if (item['location_code'] == port_str) {
      return item;
    }
  }
...
/**
 * static utility function
 * @param  {string} ship_code_str
 * @return {Object}
 */
rwas.model.Constants.get_ship_data = function(ship_code_str){

  var item = null;

  for (var i = 0, l=rwas.model.Constants.SHIP_DATA.length; i < l; i++) {

    item = rwas.model.Constants.SHIP_DATA[i];

    if (item['ship_code'] == ship_code_str) {
      return item;
    }
  }
 ...
 * @return {Object}
 */
rwas.model.Constants.get_cabin_data = function(cabin_code_str){

  var item = null;

  for (var i = 0, l=rwas.model.Constants.CABIN_DATA.length; i < l; i++) {

    item = rwas.model.Constants.CABIN_DATA[i];

    if (item['cabin_code'] == cabin_code_str) {
      return item;
    }
  }
