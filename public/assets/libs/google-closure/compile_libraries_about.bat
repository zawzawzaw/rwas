java -jar "compiler.jar" ^
  ...
  --js=..\gsap\src\minified\utils\SplitText.min.js ^
  ...
  --js=..\videojs_new\ie8\videojs-ie8.min.js ^
  --js=..\videojs_new\video.min.js ^
  --js=..\raphael\raphael.min.js ^
  --js=..\gsap\src\minified\plugins\RaphaelPlugin.min.js ^
  --compilation_level WHITESPACE_ONLY ^
  --js_output_file=..\..\js\minified\libraries-about.min.js