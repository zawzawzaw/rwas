            ...
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name" id="mName" class="required only-alpha-and-space">
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label>Middle Name*</label>
                            <input type="text" name="first_name" class="required only-alpha-and-space" id="cmName">
                        </div>
